...
\textbf{\Large Sr. AI Fullstack Developer}\\[0.4em]
\small
...
\section{Summary}
AI Specialist and Full Stack Developer with 7+ years of experience building intelligent systems and LLM-powered applications. Expert in Python, LangChain, LangGraph, and modern AI frameworks with proven track record leading AI initiatives and building production-ready conversational AI systems. Strong background in full-stack development (React, Next.js, Django, FastAPI) with expertise in real-time applications, speech synthesis integration, and technical leadership.

\section{Technical Skills}
\begin{itemize}[leftmargin=*, itemsep=0pt]
  \item \textbf{AI/ML:} LangChain, LangGraph, LLMs, OpenAI API, RAG, MCP, TensorFlow, PyTorch, Scikit-learn, Whisper, ElevenLabs API
  \item \textbf{Languages:} Python (8+ years), JavaScript/TypeScript (6+ years), SQL
  \item \textbf{Frontend:} React.js (7+ years), Next.js (6+ years), TypeScript, Tailwind CSS, Redux, Zustand, Shadcn UI
  \item \textbf{Backend:} Django, FastAPI, Flask, Node.js, NestJS, RESTful APIs, Microservices
  \item \textbf{Data Engineering:} Pandas, NumPy, ETL pipelines, BeautifulSoup, ScrapeGraph, Selenium
  ...
  \item \textbf{Automation:} n8n, WhatsApp Cloud API, Stripe integration
  \item \textbf{Software Engineering:} Clean Architecture, SOLID principles, TDD, Screaming Architecture
\end{itemize}
