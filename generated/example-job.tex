...
\section{Summary}
Senior AI Full Stack Developer with 7+ years of experience building robust, scalable AI-powered applications using modern web technologies. Expert in Python, JavaScript/TypeScript, and AI/ML frameworks including LangChain and OpenAI API. Proven track record integrating large language models into production systems, developing RESTful APIs, and delivering full-stack solutions with cloud infrastructure. Strong background in mathematics and software engineering with experience mentoring teams and leading technical initiatives.
...
\begin{itemize}[leftmargin=*, itemsep=0pt]
  ...
  \item \textbf{Frontend:} React.js (7+ years), Next.js (6+ years), Tailwind CSS, Redux, Zustand, Shadcn UI
