...
\section{Summary}
Full Stack Engineer with 7+ years of experience designing, architecting, and building robust, scalable web applications across Python and React ecosystems. Proven expertise in system design, technical decision-making, and AWS cloud infrastructure. Skilled in building production-ready APIs, managing data pipelines, and delivering high-quality solutions with strong attention to detail and process-oriented approach. Experienced collaborating with distributed teams and non-technical stakeholders.

\section{Technical Skills}
\begin{itemize}[leftmargin=*, itemsep=0pt]
  \item \textbf{Backend:} Python (8+ years), FastAPI, Django, Django REST Framework, RESTful APIs, Microservices
  ...
  \item \textbf{Databases:} PostgreSQL, MongoDB, SQL queries, ETL pipelines
  \item \textbf{Data Engineering:} Pandas, NumPy, data migration scripts, JSON parsing/manipulation
