...
\section{Summary}
I'm a Full Stack Developer with over 5 years of experience creating robust and efficient solutions across frontend and backend applications. With expertise in Node.js and a strong background in mathematics, I specialize in developing scalable applications following SOLID principles and clean code practices, while integrating emerging technologies into real-world projects to deliver innovative and impactful results.

\section{Technical Skills}
\begin{itemize}[leftmargin=*]
  \item \textbf{Languages:} JavaScript (advanced), TypeScript (advanced), Python, Rust, C
  \item \textbf{Frontend:} React.js, Next.js, HTML5, ES6
  \item \textbf{Backend:} Node.js, Express, NestJS, Django, FastAPI, GraphQL, RESTful APIs
  ...
  \item \textbf{Software Engineering:} Clean Architecture, TDD, Unit Testing, Integration Testing, SOLID principles
\end{itemize}
...
\begin{itemize}[leftmargin=*]
    \item Developed and maintained full-stack applications using Node.js, Express, React, and Next.js, following SOLID principles and clean code practices
    \item Implemented asynchronous programming with Promises, Callbacks, and async/await patterns for efficient API operations
    \item Designed and developed RESTful APIs and microservices with Node.js for data-intensive applications
\end{itemize}
